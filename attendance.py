...
def err_screen():
    ...
    tk.Label(
        sc1,
        text="Enrollment & Name requi#FCCB06!!!",
        fg="#FCCB06",
...
titl = tk.Label(
    window, text="Tech Titans", bg="#1c1c1c", fg="#FCCB06", font=("Verdana", 27, "bold"),
)
titl.place(x=600, y=12)

a = tk.Label(
    window,
    text="Welcome to Tech Titans",
    bg="#1c1c1c",  # Dark background for the main text
    fg="#FCCB06",  # Bright yellow text color
    bd=10,
...
def TakeImageUI():
    ...
    # image and title
    titl = tk.Label(
        ImageUI, text="Register Your Face", bg="#1c1c1c", fg="#B1DDF1", font=("Verdana", 30, "bold"),
    )
    ...
    txt1 = tk.Entry(
        ...
        fg="#FCCB06",  # Bright text color for input
        relief=RIDGE,
    ...
    message = tk.Label(
        ...
        fg="#FCCB06",  # Bright text color for messages
        relief=RIDGE,
    ...
    takeImg = tk.Button(
        ...
        fg="#FCCB06",  # Bright text color for the button
        height=2,
        width=12,
        relief=RIDGE,
    )
